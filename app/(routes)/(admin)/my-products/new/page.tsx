        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex space-x-4 pt-6 border-t border-gray-200">
              ...
              <Link
                href="/my-products"
                className="flex-1 bg-gray-200 text-gray-700 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 text-center transition-colors duration-200"
              >
                Cancel
              </Link>
            </div>
