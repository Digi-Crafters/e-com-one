...
const Collections = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-[600px] bg-gradient-to-br from-neutral-50 via-white to-emerald-50/30 py-12 relative overflow-hidden">
  ...
  if (error) {
    return (
      <div className="min-h-[400px] bg-gradient-to-br from-neutral-50 via-white to-emerald-50/30 py-12 flex items-center justify-center">
        ...
        <div className="max-w-md mx-auto px-4">
          ...
          >
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-3xl font-light text-neutral-900 mb-3 tracking-tight">No Collections Available</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="flex items-center justify-center gap-6 flex-wrap mt-12"
          >
